...
void addNode()
{
    ...
    if (START == NULL || newNode->noMhs <= START->noMhs)
    {
        ...
        newNode->prev = NULL;      // step 5: make the new node point to the NULL
    ...
    else
    {
        ...
        {                               // step 1.c: traverse the list to find the corrrect position
...
void deleteNode()
{
    ...
    cout << "\nEnter the roll number of the student whose record is tobe deleted";
